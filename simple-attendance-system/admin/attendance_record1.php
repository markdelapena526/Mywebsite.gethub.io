...
<body>
    ...
    <?php 
        ...
        if (isset($_POST['search'])){
            ...
            $sql = "SELECT * FROM employee_tbl INNER JOIN attendance ON employee_tbl.emp_id = attendance.emp_id WHERE employee_tbl.emp_email = '".$_POST["filter_email"]."' ORDER BY attendance_id DESC";
